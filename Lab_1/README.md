...
### Κριτική
Ήταν ενδιαφέροντα τα όσα μάθαμε σε αυτήν την εργασία. Είδαμε από την θεωρία κάποια πράγματα πως ανταποκρίνονται στην πράξη. Συναντήσαμε κάποια προβλήματα κατά την εγκατάσταση των απαραίτητων λογισμικών καθώς και στην εγκατάσταση του λειτουργικού συστήματος αλλά λύθηκαν στην συνέχεια. Συγκεκριμένα για την εγκατάσταση του εργαλείου scons χρειάστηκε η εκτέλεση της εντολής: ```sudo apt install scons m4``` η οποία είναι διαφοροποιημένη από την εντολή της εκφώνησης (Αυτό χρειάστηκε σε υπολογιστή με Ubuntu 20.04). Ακόμη για το εργαλείο pydot χρειάστηκε να γίνει εγκατάσταση του εργαλείου για την python 3 (Αυτό χρειάστηκε σε υπολογιστή με Ubuntu 18.04). Επίσης με την αλλαγή των παραμέτρων συχνότητας και μνήμης κατανοήσαμε πως αυτά επηρεαζουν την απόδοση του συστήματος. Μάθαμε για το git και την γλώσσα Markdown κάτι το οποίο βρήκαμε ενδιαφέρον και χρήσιμο.
